...
// ============================================================================
// Date Picker Component (Presentational - controlled by parent)
// ============================================================================

pub fn picker(input_attributes: List(Attribute(a))) -> Element(a) {
  html.div([class("relative")], [
    html.div([class("flex items-center gap-2")], [
      html.input([
        ...
        attribute("aria-label", "Select date"),
        attribute("aria-haspopup", "dialog"),
        attribute("aria-expanded", "false"),
        attribute("autocomplete", "off"),
        attribute("placeholder", "Select date"),
        ..input_attributes
      ]),
      html.button(
        [
          ...
          type_("button"),
          attribute("aria-label", "Choose date"),
          attribute("data-date-picker-trigger", "true"),
        ],
        [calendar_icon()],
      ),
    ]),
...
pub fn content(
  ...
  html.div(
    [
      class(
        "absolute top-full left-0 z-50 mt-2 w-auto min-w-[280px] border border-input bg-background rounded-md shadow-lg p-3 ",
      ),
      attribute("data-date-picker-content", "true"),
